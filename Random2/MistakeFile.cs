...
namespace RandomNameGenerator
{
    class Program
    {
        ...
        {
            string[] firstNames = { "Joe", "Bob", "Charlie", "David", "Eve", "Frank", "Grace", "Henry", "Isabelle", "Jack", "Kate", "Luke", "Mia", "Noah", "Olivia", "Peter", "Quinn", "Rose", "Sam", "Tara", "Uma", "Violet", "Will", "Xander", "Yara", "Zane" };
